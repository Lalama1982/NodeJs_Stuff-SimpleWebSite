...
const replaceTemplateExtjs = require('./modules/replaceTemplate');
...
const withIntJs = fs.readFileSync(`${__dirname}/templates/webindex_internaljs.html`, 'utf-8');
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/') {
    ...
    console.log('Hello from the Server. This is product!');
    res.writeHead(200, { 'Content-type': 'text/html' });
